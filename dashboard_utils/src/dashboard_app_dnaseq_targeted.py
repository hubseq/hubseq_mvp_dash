...
import dashboard_plots_dnaseq_targeted as dp
...
dp.defineCallbacks_DNASeqTargetedDashboardList(app)
dp.defineCallbacks_DNASeqTargetedAnalysisList(app)
dp.defineCallbacks_fastqcAnalysisDashboard(app)
dp.defineCallbacks_alignmentPanelAnalysisDashboard(app)
# dp.defineCallbacks_coverageAnalysisDashboard(app)
# dp.defineCallbacks_variantAnalysisDashboard(app)
